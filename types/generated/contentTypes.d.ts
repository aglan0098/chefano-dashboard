...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    fullNameAr: Attribute.String;
    fullNameEn: Attribute.String;
...
export interface ApiTermsConditionsTermsConditions extends Schema.SingleType {
...
export interface ApiUserDataUserData extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subscribed_courses: Attribute.Relation<
      'api::user-data.user-data',
      'manyToMany',
      'api::course.course'
    >;
